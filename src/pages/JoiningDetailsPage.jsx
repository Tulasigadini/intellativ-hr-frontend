...
export default function JoiningDetailsPage() {
  ...
  const saveInsurance = async () => {
    ...
    try {
      await onboardingAPI.saveInsurance(status.employee.id, {
        ...
        spouse_name:   showSpouse ? ins.spouse_name   : null,
        spouse_gender: showSpouse ? ins.spouse_gender : null,
        spouse_dob:    showSpouse ? ins.spouse_dob    : null,
  ...
  const deleteWH = async (wh) => {
    ...
    if (!window.confirm(`Delete work history at ${wh.company_name}?`)) return;
    try {
