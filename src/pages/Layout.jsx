...
export default function Layout({ children }) {
  ...
  const { taskCount }             = useNotifications();
  ...
  const NAV = [
    ...
    },
    {
      ...
      items: [
        { to: '/onboarding',       label: 'Onboarding',        icon: '🚀', perm: 'can_onboard_employees' },
        { to: '/onboarding-tasks', label: 'Onboarding Tasks',  icon: '📋', always: true },
    ...
    <div className="app-shell">
      ...
      <aside className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
        <div className="sidebar-logo">
          ...
          <span className="sidebar-logo-text">Intellativ HR</span>
        </div>
